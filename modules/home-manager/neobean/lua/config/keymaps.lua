...
vim.keymap.set({ "n", "v", "i" }, "<M-z>", function()
  ...
  -- Add .com to github
  goProjectPath = goProjectPath:gsub("github", "github.com")
  -- You can add your GitHub username here if needed
  -- goProjectPath = goProjectPath:gsub("github.com", "github.com/yourusername")
