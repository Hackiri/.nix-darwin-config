      ...
      providers = {
        ...
        dictionary = {
          ...
          opts = {
            ...
            -- have your .txt files
            dictionary_directories = { vim.fn.expand("~/.nix-darwin-config/modules/home-manager/neobean/dictionaries") },
            -- Notice I'm also adding the words I add to the spell dictionary
            dictionary_files = {
              vim.fn.expand("~/.nix-darwin-config/modules/home-manager/neobean/spell/en.utf-8.add"),
              vim.fn.expand("~/.nix-darwin-config/modules/home-manager/neobean/spell/es.utf-8.add"),
            },
