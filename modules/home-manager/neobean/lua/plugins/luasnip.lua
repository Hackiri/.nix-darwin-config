...
return {
  ...
  opts = function(_, opts)
    ...
    table.insert(
      ...
      s({
        trig = "dotfileslatest",
        name = "Adds -> [my dotfiles](https://github.com/yourusername/dotfiles)",
        desc = "Add link to your dotfiles repository",
      }, {
        t("[my dotfiles](https://github.com/yourusername/dotfiles)"),
      })
    )
    ...
    table.insert(
      ...
      s({
        ...
        t({
          ...
          "☕ Support me -> https://example.com/support",
          "",
          "❤‍🔥 My social media -> https://example.com/social",
          "",
          "My dotfiles -> https://github.com/yourusername/dotfiles",
          "A link to my website -> https://example.com",
        }),
      })
    )
    ...
    table.insert(
      ...
      s({
        ...
        t({
          ...
          "",
          '- If you want to share a tip, you can [donate here](https://example.com/donate){:target="_blank"}',
          ...
          '- [Social Media](https://example.com/social){:target="_blank"}',
          '- [Instagram](https://www.instagram.com/link_arzu){:target="_blank"}',
          '- [GitHub](https://github.com/yourusername){:target="_blank"}',
          '- [Threads](https://www.threads.net/@link_arzu){:target="_blank"}',
          '- [Website](https://example.com){:target="_blank"}',
          '- [YouTube](https://youtube.com){:target="_blank"}',
          '- [Support](https://example.com/support){:target="_blank"}',
          "",
          ...
          '  - [Example blog post](https://example.com/blog/post){:target="_blank"}',
