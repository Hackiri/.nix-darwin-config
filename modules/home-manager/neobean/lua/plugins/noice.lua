...
return {
  {
    ...
    opts = {
      ...
      notify = {
        ...
        -- Disabled to prevent deprecated notifications warning
        enabled = true,
        view = {
          backend = "snacks", -- Use the modern snacks backend
          fallback = "notify", -- Fallback to notify if snacks is not available
        },
      },
      lsp = {
        message = {
