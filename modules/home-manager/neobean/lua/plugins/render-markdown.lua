...
return {
  ...
  init = function()
    local colorInline_bg = colors["color02"]
    local color_fg = colors["color26"]
    -- local color_sign = "#ebfafa"
    if vim.g.md_heading_bg == "transparent" then
      -- Define color variables
      local color1_bg = colors["color04"]
      local color2_bg = colors["color02"]
      local color3_bg = colors["color03"]
      local color4_bg = colors["color01"]
      local color5_bg = colors["color05"]
      local color6_bg = colors["color08"]
      local color_fg1 = colors["color18"]
      local color_fg2 = colors["color19"]
      local color_fg3 = colors["color20"]
      local color_fg4 = colors["color21"]
      local color_fg5 = colors["color22"]
      local color_fg6 = colors["color23"]
